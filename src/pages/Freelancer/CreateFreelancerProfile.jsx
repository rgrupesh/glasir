...
import CreateProfileForm from "../../components/freelancer/CreateProfileForm";
...
const CreateFreelancerProfile = ({ history }) => {
...
export default withRouter(CreateFreelancerProfile);
